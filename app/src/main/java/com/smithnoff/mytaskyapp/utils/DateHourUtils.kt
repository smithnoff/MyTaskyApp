...
fun getReminderTime(time: Long, reminderTime: Long): ReminderOptions {
    return when(time - reminderTime){
        ReminderOptions.HalfHour.time -> ReminderOptions.HalfHour
        ReminderOptions.OneDay.time -> ReminderOptions.OneDay
        ReminderOptions.OneHour.time -> ReminderOptions.OneHour
        ReminderOptions.SixHour.time -> ReminderOptions.SixHour
        else -> ReminderOptions.TenMinutes
    }
}